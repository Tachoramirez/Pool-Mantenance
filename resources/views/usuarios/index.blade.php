<x-app-layout>
    <x-slot name="header">
        ...
        <div class="col-span-1"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Usuarios</h2></div>
        </div>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-primary-button class="mb-2">
                <a href="{{route('usuarios.create')}}">{{__('Nuevo usuario')}}</a>
            </x-primary-button>
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            ...
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    <td class="p-2"><div class="text-left font-medium">{{$usuario->name}}</div></td>
                                    <td class="p-2"><div class="text-left font-medium">{{$usuario->email}}</div></td>
                                    ...
                                    <td class="p-2">
                                        <div class="flex justify-center">
                                            <a class="btn" href="{{route('usuarios.show', $usuario->id)}}" title="ver">
                                            ...
                                            <a class="btn" href="{{route('usuarios.edit', $usuario->id)}}" title="editar">
