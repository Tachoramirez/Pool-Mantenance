                ...
                <div class="">
                    <form method="POST" action="{{ route('usuarios.update', $usuario) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" value="{{$usuario->name}}" required autocomplete="nombre" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="num_cel" class="block mt-1 w-full" type="text" name="num_cel" value="{{$usuario->num_cel}}" required autofocus autocomplete="num_cel" />
