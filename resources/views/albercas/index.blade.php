<x-app-layout>
    <x-slot name="header">
        ...
        <div class="col-span-1"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Albercas</h2></div>
        </div>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-primary-button class="mb-2">
                <a href="{{route('albercas.create')}}">{{__('Nueva alberca')}}</a>
            </x-primary-button>
                    ...
                    <table class="w-full table-auto">
                        <thead class="bg-blue-50 text-xs font-semibold uppercase text-gray-400">
                            <tr>
                                ...
                                <th class="p-2">
                                    <div class="text-left font-semibold">Cliente</div>
                                </th>
                                <th class="p-2">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            ...
                            @foreach ($albercas as $alberca)
                                <tr>
                                    <td class="p-2"><div class="text-left font-medium">{{$alberca->nombre}}</div></td>
                                    <td class="p-2"><div class="text-left font-medium">{{$alberca->name}}</div></td>
                                    ...
                                    <td class="p-2">
                                        <div class="flex justify-center">
                                            <a class="btn" href="{{route('albercas.show', $alberca->id)}}" title="ver">
                                            ...
                                            <a class="btn" href="{{route('albercas.edit', $alberca->id)}}" title="editar">
                                            ...
                                            <a class="btn" title="borrar">
                                                <form action="{{route('albercas.destroy', $alberca->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit">
